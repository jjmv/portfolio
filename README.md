...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create portfolio-9603
  fly apps create portfolio-9603-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app portfolio-9603
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app portfolio-9603-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'portfolio-9603-staging' does not match app name in config file 'portfolio-9603'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name portfolio-9603-db
  fly postgres attach --app portfolio-9603 portfolio-9603-db

  fly postgres create --name portfolio-9603-staging-db
  fly postgres attach --app portfolio-9603-staging portfolio-9603-staging-db
  ```
